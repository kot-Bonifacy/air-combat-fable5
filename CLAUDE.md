...
Fazy ukończone: **0–18 + domknięcie parytetu MP↔SP (P1–P5) + Faza 19 (19a ✅, 19b ✅) + Faza 20 ✅ + Faza 21 (audio ✅; wizualia → backlog) + Faza 22 (cz.1 ✅, cz.2 ✅, cz.3 ✅, cz.4 ✅; cz.5 ⏳)**. Szczegóły
...
| 22    | **Modułowe uszkodzenia (5 części)**: strefy z HP + integralność (hybryda); cz.1 fundament shared, cz.2 serwer hit-detection po strefach+maszyna stanów, cz.3 **protokół v8** (u16 stref w snapshocie)+predykcja klienta+ucieczka botów, cz.4 klient: HUD sylwetki (SVG strefy+flagi) + wizualia obcych (dym narastający z silnikiem, ogień u silnika, dym z końcówki skrzydła) + moduł w komunikacie śmierci | cz.1–4 ✅ **575→589 testów zielone**; cz.3 **wymaga deployu front+back RAZEM (v8)**, cz.4 czysto klienckie (czyta v8); pozostało cz.5 (balans+tag `1.0`); ⏳ user: smoke v8 + playtest + fps RTX @8 (patrz `docs/phases/faza-22.md`) |
